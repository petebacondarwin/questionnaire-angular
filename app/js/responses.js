(function() {
  ...
  angular.module('ResponseModule', []).service("ResponseService", [
    '$http', '$rootScope', '$q', '$routeParams', '$log', function($http, $rootScope, $q, $routeParams, $log) {}, buildResponse = function(questionnaire, answers) {
      var now, response;
      now = new Date();
      return response = {
    ...
    }, this.submitResponse = function(questionnaire, answers) {
      var db, response;
